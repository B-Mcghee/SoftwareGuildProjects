...
public class VendingPersistenceException extends Exception {
     ...
     */
    public VendingPersistenceException() {
    }
     ...
     * @since 1.4
     */
    public VendingPersistenceException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public VendingPersistenceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
