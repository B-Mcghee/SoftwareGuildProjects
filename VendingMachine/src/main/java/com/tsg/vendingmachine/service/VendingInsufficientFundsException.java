...
public class VendingInsufficientFundsException extends Exception {
     ...
     */
    public VendingInsufficientFundsException() {
    }
     ...
     * @since 1.7
     */
    public VendingInsufficientFundsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
