...
public class VendingNoItemInventoryException extends Exception {
     ...
     */
    public VendingNoItemInventoryException() {
    }
     ...
     * @since 1.7
     */
    public VendingNoItemInventoryException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
